          ...
          <div className="col-lg-5 col-md-5 col-sm-12 col-xs-12">
            <div className="widget w-info">
              <div className="site-logo">
                <a href="/" className="full-block">
                  &nbsp;
                </a>
                <div className="logo-text">
                  <div className="logo-title">ticketteer</div>
                  <div className="logo-sub-title">
                    Verkauf doch einfach MEHR Tickets!
                  </div>
                </div>
              </div>

              <p>
                Ticketteer wurde 2017 als Hauptprodukt in die Flinkwork
                eingebracht. Durch ständige Nähe zu diversen mittleren und
                kleinen Veranstaltern hat sich die Software immer an den
                Bedürfnissen der Veranstalter orientiert. Sie wurde im Herbst
                2017 mit einer einfachen Bezahlfunktion für Veranstalter
                veröffentlicht. Seither wächst die Fangemeinde um Ticketteer im
                Raum Österreich und Deutschland.
              </p>
          ...
          <div className="col-lg-3 col-lg-offset-1 col-md-4 col-sm-12 col-sm-offset-0 col-xs-12">
            <div className="widget w-contacts">
              ...
              <div className="contact-item display-flex">
                ...
                <span className="info">+43 1 43 50 229</span>
              </div>
              <div className="contact-item display-flex">
            ...
            <div className="widget w-follow">
              <ul>
                ...
                <li>
                  <a
                    target="_blank"
                    href="https://facebook.com/ticketteer"
                ...
                <li>
                  <a
                    target="_blank"
                    href="https://twitter.com/ticketteer"
                    rel="noopener noreferrer"
                  >
                ...
                <li>
                  <a
                    target="_blank"
                    href="https://linkedin.com/company/ticketteer"
                    rel="noopener noreferrer"
                  >
          ...
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <span>
                ...
                <a href="index.html" className="sub-footer__link">
                  ticketteer
                </a>
              </span>
