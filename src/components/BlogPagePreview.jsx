    ...
    <section className="">
      <article className="hentry post post-standard has-post-thumbnail sticky">
        ...
        <div className="post-thumb">
          ...
          <a href="img/blog1.jpg" className="link-image js-zoom-image">
        ...
        <div className="post__content">
          ...
          <div className="share-product">
            ...
            <ul className="socials">
              <li>
                <button className="social__item facebook">
              ...
              <li>
                <button className="social__item twitter">
              ...
              <li>
                <button className="social__item googlePlus">
        ...
        <div className="post__content-info">
          ...
          <a href={`/blog/${opts.entry.uid}`} className="h5 post__title entry-title">
            {blog.title.text}  
          </a>

          <p className="post__text">{blog.teaser_content.text}</p>
          ...
          <div className="post-additional-info">
            ...
            <Link to={`/blog/${opts.entry.uid}`} className="btn-next">
